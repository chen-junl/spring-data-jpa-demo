package com.example.demotest.entity.named_entity_graph;
...
@NamedEntityGraph(name = "Student3.books",
        attributeNodes = {@NamedAttributeNode("books")})
public class StudentNamedEntityGraphType3Entity {
    /**
     * 主键
     */
    @Id
    ...
    private List<StudentBooksNamedEntityGraphEntity> books;
}
