package com.example.demotest.entity.many_to_many.attribute.cascade;
...
public class CourseManyToManyAttributeCascade0Entity {
    /**
     * 主键
     */
    @Id
    ...
    private List<StudentManyToManyAttributeEntity> students;
}
